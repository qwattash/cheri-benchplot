...
def test_netperf_exec_task_default(netperf_session, mock_qemu_instance, mock_run_script):
    ...
    expect_lines = [
        ...
        r"STATCOUNTERS_NO_AUTOSAMPLE=1 /opt/riscv64-purecap/netperf/bin/netperf >> /root/benchmark-output/0/exec-netperf-8bc941a3-f6d6-4d37-b193-4738f1da3dae.csv",
        r"STATCOUNTERS_NO_AUTOSAMPLE=1 /opt/riscv64-purecap/netperf/bin/netperf >> /root/benchmark-output/1/exec-netperf-8bc941a3-f6d6-4d37-b193-4738f1da3dae.csv",
        r"kill -TERM \$PID_5"
    ]
    ...
    qemu_instance_object.extract_file.assert_any_call(
        Path("/root/benchmark-output/0/exec-netperf-8bc941a3-f6d6-4d37-b193-4738f1da3dae.csv"), ANY)
    qemu_instance_object.extract_file.assert_any_call(
        Path("/root/benchmark-output/1/exec-netperf-8bc941a3-f6d6-4d37-b193-4738f1da3dae.csv"), ANY)
...
def test_netperf_exec_task_args(netperf_args_session, mock_qemu_instance, mock_run_script):
    ...
    expect_lines = [
        ...
        r"sysctl hw.qemu_trace_perthread=1",
        r"STATCOUNTERS_NO_AUTOSAMPLE=1 /opt/riscv64-purecap/netperf/bin/netperf --foo --bar >> /root/benchmark-output/0/exec-netperf-8bc941a3-f6d6-4d37-b193-4738f1da3dae.csv",
        r"STATCOUNTERS_NO_AUTOSAMPLE=1 /opt/riscv64-purecap/netperf/bin/netperf --foo --bar >> /root/benchmark-output/1/exec-netperf-8bc941a3-f6d6-4d37-b193-4738f1da3dae.csv",
        r"kill -TERM \$PID_5"
    ]
    check_lines_match(mock_run_script.getvalue().split("\n"), expect_lines)
