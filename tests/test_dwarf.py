...
def test_extract_struct_multi_typedef(dwhelper):
    ...
    assert x["member_type_is_ptr"] == False
    assert x["member_type_is_struct"] == False
    assert x["member_type_is_union"] == False
    assert x["member_type_is_typedef"] == True
