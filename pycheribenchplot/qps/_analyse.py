...
#             "expr": (
#                 pl.col("executive_entry")
#                 / (pl.col("message_count") * pl.col("resp_size"))
#             ),
#         },
#     }
...
#         )
#         assert len(pmc_df.filter(iteration=-1)) == 0, (
#             "Missing iteration number on PMC frame"
#         )
#         # Join with the QPS data
#         qps_df = self.qps_data.merged_df.get().with_columns(
#             pl.col("iteration").cast(pl.Int32)
#         )
#         assert len(qps_df.filter(iteration=-1)) == 0, (
#             "Missing iteration number on QPS frame"
#         )
