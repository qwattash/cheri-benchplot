...
class AdvisoryHistoryConfig(Config):
    events: dict[date, str] = config_field(
        lambda: DEFAULT_EVENTS, desc="Events to mark on the top X axis timeline"
    )
...
class CheriBSDAdvisoriesHistory(PlotTask):
    ...
    def run_plot(self):
        raise NotImplementedError("TODO: Migrate to new plotting infrastructure")
        # df = self.sa.df.get()
...
class CheriBSDAdvisoriesTables(AnalysisTask):
    ...
    def _advisories_summary(self):
        raise NotImplementedError("TODO: Migrate to polars")
        # df = self.sa.df.get()
...
class CheriBSDAdvisoriesCDF(PlotTask):
    ...
    @dependency
    def sa_load(self):
        raise NotImplementedError("TODO: Recover dependency, deleted by mistake?")
    ...
    def run_plot(self):
        ...
        raise NotImplementedError(
            "TODO: Recover implementation: Marker has been deleted?"
        )
        ...
        raise NotImplementedError("TODO: Migrate to new plot infrastructure")
        # sns.set_theme()
