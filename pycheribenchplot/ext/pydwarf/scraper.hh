...
#define HANDLE_DW_TAG(ID, NAME, VERSION, VENDOR, KIND)                  \
  case ID: {                                                            \
    constexpr bool has_visit = requires(                                \
        S &s_ref, llvm::DWARFDie &die_ref) {                            \
...
class DwarfScraper {
 ...
 protected:
   ...
   * This is called when the scraper is initialized. The schema may already
   * exist.
   */
   ...
   */
  virtual void BeginUnit(llvm::DWARFDie &unit_die) {};
  virtual void EndUnit(llvm::DWARFDie &unit_die) {};
