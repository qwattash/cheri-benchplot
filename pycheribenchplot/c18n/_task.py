...
#     kdump: ConfigPath = field(
#         default=None, metadata=dict(validate=validate_file_exists)
#     )
...
#         show_df = df.reset_index().pivot(
#             index=["callee_compartment", "symbol"], columns="op", values="count"
#         )
...
#                 thickness_range = (
#                     self.config.edge_thickness_limits[1]
#                     - self.config.edge_thickness_limits[0]
#                 )
#                 edge["penwidth"] = (
#                     self.config.edge_thickness_limits[0] + thickness_range * norm_weight
#                 )
...
#         df["parent_sequence"] = (
#             df[["sequence", "depth"]].groupby("depth").shift(1).fillna(-1)
#         )
