...
class IngestPMCCounters(DataFrameLoadTask):
    """
    ...
    def counter_group(self):
        return self.target.task.pmc_group_id

    @property
    def counter_names(self):
        return self.target.task.pmc_names
...
class PMCExec(ExecutionTask):
    ...
    def pmc_group_id(self) -> str:
        """String that identifies the set of counters collected by this execution"""
        return self.config.group or "/".join(self.config.counters)
