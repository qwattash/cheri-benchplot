...
class CommonPlatformOptions(Config):
    ...
    vcu118_bios: ConfigPath | None = config_field(None, desc="VCU118 bios.")

    vcu118_ip: str = config_field("10.88.88.2", desc="IP to use for the VCU118 board.")
...
class PlatformOptions(Config):
    ...
    #: Trace categories to enable for qemu-perfetto
    #: Deprecated and should go away
    qemu_trace_categories: Set[str] | None = None

    vcu118_bios: ConfigPath | None = config_field(None, desc="VCU118 bios.")

    vcu118_ip: str | None = config_field(None, desc="IP to use for the VCU118 board.")
