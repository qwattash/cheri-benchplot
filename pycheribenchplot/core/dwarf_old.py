...
class DWARFInfoSource:
    ...
    def build_struct_layout_graph(self, container, g: nx.DiGraph | None = None) -> nx.DiGraph:
        """
    ...
    def parse_struct_layout(self, container, root: pydwarf.TypeInfo | None = None) -> DataFrame[DWARFStructLayoutModel]:
        """
